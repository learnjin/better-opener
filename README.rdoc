...
mail_view[https://github.com/37signals/mail_view] gems this better_opener tries
to be *better* by:

- providing support for notifications in general (sms so far)
